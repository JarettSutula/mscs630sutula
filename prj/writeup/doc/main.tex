...
%	General information
%---------------------------------------------------------------------------------
\title{Security Algorithms Final Writeup} % Adds your title
\author{
Jarett Sutula % Add your first and last name
    %\thanks{} % Adds a footnote to your title
    %\institution{YOUR INSTITUTION} % Adds your institution
  }

\date{Due May 15th, 2022} % Adds the current date to your “cover” page; leave empty if you do not want to add a date
