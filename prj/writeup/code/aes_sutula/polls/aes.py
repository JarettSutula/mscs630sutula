...
# key_hex = plaintext_to_hex("11")
# plain_text = "bestbuy.com"
# # plain_text = "apple.com"
# pt = plaintext_to_hex(plain_text)
# print(pt)
# encrypted = aes_encryption(pt, key_hex)
# print(encrypted)
# decrypted = aes_decryption(encrypted, key_hex)
# print(decrypted)
# cipher_x = hex_to_plaintext(decrypted)
# print(cipher_x)
# print("plain text: ", plain_text)
# cipher_text = aes_encryption(plain_text, key_hex)
# print("cipher text: ", cipher_text[0])
# uncipher_text = aes_decryption(cipher_text[0], key_hex)
# print("decoded text: ", uncipher_text[0])

# plain_text_2 = "Now is the tim"
# test_12 = plaintext_to_hex(plain_text_2)
# print(test_12)
# test_13 = hex_to_plaintext(test_12)
# print(test_13)


# inv_sbox_test = "63C0AB20EB2F30CB9F93AF2BA092C7A2"
# test_4 = "632FAFA2EB93C7209F92ABCBA0C0302B"
# test_5 = aes_mix_column(change_to_hex_matrix(test_4))
# print(test_4)

# test_6 = "BA75F47A84A48D32E88D060E1B407D5D"
# test_7 = aes_inv_mix_column(change_to_hex_matrix(test_6))
# matrix_to_hex_string(test_7)
# test_1 = aes_shift_row(change_to_hex_matrix(inv_sbox_test))
# matrix_to_hex_string(test_1)
# test_2 = aes_inv_shift_row(test_1)
# print(inv_sbox_test)
# matrix_to_hex_string(test_2)


# key_hex = '544F4E20776E69546F656E772020656F'
# plain_text = '5473206768204B20616D754673796E75'

# cipher_text = aes_encryption(plain_text, key_hex)
# decrypted_text = aes_decryption(cipher_text, key_hex)
# ist = change_to_hex_matrix(inv_sbox_test)
# ist_2 = aes_inv_nibble_sub(ist)
# matrix_to_hex_string(ist_2)

# key_hex_2 = change_to_hex_matrix(key_hex)
# plain_text_2 = change_to_hex_matrix(plain_text)

# def print_4x4(thing):
#     for i in range(4):
#         for j in range(4):
#             print(hex(int(thing[j][i]))[2:].upper().zfill(2), end = ' ')
#         print()
#     print()

# # print_4x4(key_hex_2)
# # print_4x4(plain_text_2)
# test = 5 + 2
# print_4x4(out)